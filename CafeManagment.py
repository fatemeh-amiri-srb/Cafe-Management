...
class cafe_management():
        ...
        def __init__(self):
                ...
                self.heading = Label(self.root,text="Cafe Management System",font=('verdana',20,'bold'),fg="#330066",bg="white")
                self.heading.place(x=60,y=5)
                
                self.style1 = Label(self.root,bg="#d9b3ff",height=1,width=17)
                self.style1.place(x=0,y=50)
                self.style2 = Label(self.root,bg="#d9b3ff",height=1,width=30)
                self.style2.place(x=380,y=50)
                self.welcome=Label(self.root ,text="--Welcome to our Cafe--",font=('verdana',10,'bold'),bg="white",fg="#330066")
                self.welcome.place(x=140,y=50)
                ...
                self.frame1 = LabelFrame(self.root,text="Cafe Items",width=150,height=200,font=('verdana',10,'bold'),borderwidth=3,relief=RIDGE,highlightthickness=4,bg="white",highlightcolor="white",highlightbackground="white",fg="#330066")
                self.frame1.place(x=30,y=90)
                
                self.tea = Label(self.frame1,text="Tea",font=('verdana',10,'bold'),bg="white")
                self.tea.place(x=3,y=1)
                self.tea_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                ...
                self.coffee_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                ...
                self.sandwitch_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                ...
                self.cake_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                ...
                self.burger_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                ...
                self.pizza_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                ...
                self.fries_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                ...
                self.pepsi_item = Entry(self.frame1,width=7,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                self.pepsi_item.place(y=140,x=85)

                self.frame2 = LabelFrame(self.root,text="Cafe Items Bills",width=180,height=160,font=('verdana',10,'bold'),borderwidth=3,relief=RIDGE,highlightthickness=4,bg="white",highlightcolor="white",highlightbackground="white",fg="#330066")
                ...
                self.items_cost = Entry(self.frame2,width=9,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                ...
                self.service_cost = Entry(self.frame2,width=9,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                ...
                self.sub_cost = Entry(self.frame2,width=9,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                ...
                self.paid_tax = Entry(self.frame2,width=9,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                ...
                self.total_bill = Entry(self.frame2,width=9,borderwidth=4,relief=SUNKEN,bg="#d9b3ff")
                self.total_bill.place(y=100,x=100)
                self.Total_Bills_btn = Button(self.root,text="Total",relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#d9b3ff',fg="#330066",command=self.Total_Bill)
                self.Total_Bills_btn.place(x=360,y=245)
                
                self.Clear_btn = Button(self.root,text="Clear",relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#d9b3ff',fg="#330066",command=self.Clear)
                self.Clear_btn.place(x=410,y=245)
        
                self.icon = ImageTk.PhotoImage(Image.open('false.png'))
                self.Quit_btn = Button(self.root,image=self.icon,relief=RAISED,borderwidth=2,font=('verdana',10,'bold'),bg='#d9b3ff',fg="white",padx=5,command=self.Quit)
